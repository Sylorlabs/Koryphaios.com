    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b" style={{ borderColor: BORDER }}>
          ...
          <button onClick={onClose} className="p-1.5 rounded-lg hover:bg-white/5 transition-colors" style={{ color: MUTED }}>
            <X size={18} />
          </button>
        </div>
                ...
                <div key={provider.name} className="p-3 rounded-lg" style={{ background: S2 }}>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="w-8 h-4 rounded-full relative" style={{ background: provider.enabled ? ACCENT : S3 }}>
                        <div className="absolute top-0.5 w-3 h-3 rounded-full bg-white transition-all duration-200" style={{ left: provider.enabled ? "18px" : "2px" }} />
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="w-8 h-4 rounded-full relative" style={{ background: SETTINGS_DATA.preferences.autoCommit ? ACCENT : S3 }}>
                      <div className="absolute top-0.5 w-3 h-3 rounded-full bg-white transition-all duration-200" style={{ left: SETTINGS_DATA.preferences.autoCommit ? "18px" : "2px" }} />
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="w-8 h-4 rounded-full relative" style={{ background: SETTINGS_DATA.preferences.autoLint ? ACCENT : S3 }}>
                      <div className="absolute top-0.5 w-3 h-3 rounded-full bg-white transition-all duration-200" style={{ left: SETTINGS_DATA.preferences.autoLint ? "18px" : "2px" }} />
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
              ...
              <div className="p-3 rounded-lg" style={{ background: S2 }}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <button className="px-2 py-0.5 rounded text-xs hover:bg-white/10 transition-colors" style={{ background: S3, color: TEXT2 }}>-</button>
          ...
          {activeTab === "shortcuts" && (
            <div className="space-y-1">
              {SETTINGS_DATA.shortcuts.map((shortcut) => (
                <div key={shortcut.action} className="flex items-center justify-between p-3 rounded-lg hover:bg-white/5 transition-colors" style={{ background: S2 }}>
